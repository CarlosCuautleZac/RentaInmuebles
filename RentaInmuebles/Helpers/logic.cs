...
namespace RentaInmuebles.Helpers
{
    class logic
    {
        public string sendMail(string to, string asunto, string body)
        {
            ...
            string from = "InmobiliariaLaPonderosa@outlook.com";
            string displayName = "Inmbuebles Cuautle";
            try
            {
                ...
                client.Credentials = new NetworkCredential(from, "Sistemas19");
